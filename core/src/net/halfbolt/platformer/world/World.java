...
public class World {
    ...
    public World(Render render) {
        ...
        enemies.add(new SmallEnemy(new Point(8, 15), this));
        enemies.add(new SmallEnemy(new Point(10, 15), this));
        enemies.add(new SmallEnemy(new Point(12, 15), this));
        enemies.add(new TankEnemy(new Point(14, 15), this));
    }
